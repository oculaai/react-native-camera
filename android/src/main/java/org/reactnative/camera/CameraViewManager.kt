...
//import org.reactnative.camera.RNCameraView.onHostDestroy
//import org.reactnative.camera.RNCameraView.setUseNativeZoom
//import org.reactnative.camera.RNCameraView.setBarCodeTypes
//import org.reactnative.camera.RNCameraView.setDetectedImageInEvent
//import org.reactnative.camera.RNCameraView.setShouldScanBarCodes
//import org.reactnative.camera.RNCameraView.setShouldDetectTouches
//import org.reactnative.camera.RNCameraView.setShouldDetectFaces
//import org.reactnative.camera.RNCameraView.setFaceDetectionMode
//import org.reactnative.camera.RNCameraView.setFaceDetectionLandmarks
//import org.reactnative.camera.RNCameraView.setFaceDetectionClassifications
//import org.reactnative.camera.RNCameraView.setTracking
//import org.reactnative.camera.RNCameraView.setShouldGoogleDetectBarcodes
//import org.reactnative.camera.RNCameraView.setGoogleVisionBarcodeType
//import org.reactnative.camera.RNCameraView.setGoogleVisionBarcodeMode
//import org.reactnative.camera.RNCameraView.setShouldRecognizeText
//import org.reactnative.camera.RNCameraView.setRectOfInterest
//import org.reactnative.camera.RNCameraView.setCameraViewDimensions
...
class CameraViewManager : ViewGroupManager<RNCameraView>() {
    enum class Events(private val mName: String) {
        EVENT_CAMERA_READY("onCameraReady"),
        EVENT_ON_MOUNT_ERROR("onMountError"),
        EVENT_ON_BAR_CODE_READ(
            "onBarCodeRead"
        ),
        EVENT_ON_FACES_DETECTED("onFacesDetected"),
        EVENT_ON_BARCODES_DETECTED("onGoogleVisionBarcodesDetected"),
        EVENT_ON_FACE_DETECTION_ERROR(
            "onFaceDetectionError"
        ),
        EVENT_ON_BARCODE_DETECTION_ERROR("onGoogleVisionBarcodeDetectionError"),
        EVENT_ON_TEXT_RECOGNIZED(
            "onTextRecognized"
        ),
        EVENT_ON_PICTURE_TAKEN("onPictureTaken"),
        EVENT_ON_PICTURE_SAVED("onPictureSaved"),
        EVENT_ON_RECORDING_START(
            "onRecordingStart"
        ),
        EVENT_ON_RECORDING_END("onRecordingEnd"),
        EVENT_ON_TOUCH("onTouch"),
        EVENT_ON_EXPOSURE_CHANGE(
            "onExposureChange"
        ),
        EVENT_ON_AUDIO_LEVEL_CHANGE("onAudioLevelChange");
